...
import com.dmrval.hospitalapp.service.SecurityServise;
...
public class UserController {
    ...
    public String registration(@ModelAttribute("userForm") User userForm, BindingResult bindingResult, Model model) {
        ...
        securityServise.autoLogin(userForm.getLogin(), userForm.getConfirmPassword());
    ...
    public String login(Model model,String error, String logout) {
        ...
        if (logout!=null) {
            model.addAttribute("message", "Выполнен выход из профиля");
        }
        return "login";
    }
