...
public class MainController {
  ...
  @Autowired private MedicalpolicyService medicalpolicyService;
  ...
  @Autowired private RoleSevice roleSevice;
  ...
  public String addDoctorPost(
    ...
    Address address_tmp =
        new Address(country, city, street, Integer.parseInt(house), Integer.parseInt(flat));
    User user = new User(login, passwordEncoder.encode("123456"), roleSevice.findById(9));
    userService.saveUser(user);
    Doctor doctor =
        new Doctor(birthday, firstname, lastname, specialization, address_tmp, lic_tmp, user);
  ...
  public String addPatientPost(
    ...
    Patient patient =
        new Patient(firstname, lastname, birthday, address_tmp, med_tmp, userForPatient);
  ...
  public String setDiagnosis(
      @RequestParam("textdiag") String textdiag, @RequestParam("visitid") String visitid) {
  ...
  public String updateVisit(
    ...
    Visit tmp =
        new Visit(
            new_time,
            doctorService.getDoctor(Integer.parseInt(doctor)),
  ...
  public String signUpPost(
    ...
    Patient patient =
        new Patient(firstname, lastname, new Medicalpolicy(Long.parseLong(medicalpolicy)), user);
    patientService.addPatient(patient);
  ...
  public String getPatAddvisit(
      @RequestParam String currTime, Principal principal, @RequestParam String doctor) {
    Timestamp t = visitService.getWorkCalendar().getWorkCalendar().get(Integer.parseInt(currTime));
    Visit visit =
        new Visit(
            t,
            doctorService.getDoctor(Integer.parseInt(doctor)),
            patientService.getPatientbyLogin(principal.getName()));
  ...
  public String getDocAddvisit(
      @RequestParam String currTime, Principal principal, @RequestParam String patient) {
