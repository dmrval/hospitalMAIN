...
<table>
    ...
    <tr>
        ...
        <td><a href="/administrator/allPatients/update/${patient.getPatientid()}">РЕДАКТИРОВАТЬ</a></td>
        <td><a href="/administrator/allPatients/delete/${patient.getPatientid()}">УДАЛИТЬ</a></td>
    </tr>
    <#else>
