...
<head>
    <meta charset="UTF-8">
    <title>Редактирование вашего профиля ${doctor.getDoctorid()}</title>
    <style type="text/css">
...
<form name="doc" action="/doc_docSettings" method="post" class="editDoctor">
...
<br>
<div>
    <button class="button21" onclick="location.href = '/doctor'">Отмена</button>
</div>
<div id="footer">
